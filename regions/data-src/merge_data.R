...
db_region <- arrow::read_parquet("data/tab_region.parquet") %>%
  filter(Libellé != "Ensemble" & Libellé != "DROM") %>%
...
ligne_a_dupliquer <- db_region[12, ]
